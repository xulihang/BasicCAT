...
Public Sub RichTextBorderColor(dir As String) As Paint
	If File.Exists(dir,"richtext_bordercolor") Then
		Dim rgb As String=File.ReadString(dir,"richtext_bordercolor").Trim
